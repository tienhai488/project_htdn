        ...
        <div id="users-box" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    @can(Acl::PERMISSION_ORDER_ADD_BUSINESS)
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        let urlEdit = `{{ route('admin.order.edit', ':id') }}`.replace(':id', data);

                        return `
                            <div class="action-btns">
                                <x-table.actions.edit-action
                                    :permission="Acl::PERMISSION_ORDER_EDIT_BUSINESS"
                                    :url="'${urlEdit}'"
                                />
                            </div>
                        `;

                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Quản lý đơn vị vận chuyển</h4>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-area">
                    @can(Acl::PERMISSION_SHIPPING_UNIT_ADD_BUSINESS)
                        ...
                        return `
                            <div class="action-btns">
                                <x-table.actions.edit-action
                                    :permission="Acl::PERMISSION_SHIPPING_UNIT_EDIT_BUSINESS"
                                    :url="'${urlEdit}'"
                                />
                                <x-table.actions.delete-action
                                    :permission="Acl::PERMISSION_SHIPPING_UNIT_DELETE_BUSINESS"
                                    :url="'${urlDestroy}'"
                                />
                            </div>
                        `;

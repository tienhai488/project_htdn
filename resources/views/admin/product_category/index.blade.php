        ...
        <div id="users-box" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    @can(Acl::PERMISSION_PRODUCT_CATEGORY_ADD_WAREHOUSE)
                        ...
                        return `
                            <div class="action-btns">
                                <x-table.actions.edit-action
                                    :permission="Acl::PERMISSION_PRODUCT_CATEGORY_EDIT_WAREHOUSE"
                                    :url="'${urlEdit}'"
                                />
                                <x-table.actions.delete-action
                                    :permission="Acl::PERMISSION_PRODUCT_CATEGORY_DELETE_WAREHOUSE"
                                    :url="'${urlDestroy}'"
                                />
                            </div>
                        `;

...
@section('content')
    <div class="layout-top-spacing col-12">
        <a href="{{ route('admin.customer.index') }}" class="btn btn-default _effect--ripple waves-effect waves-light">
            Trở lại
        </a>
    </div>
        ...
        <div id="supplier-management" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area" style="padding: 20px !important;">
                    <div class="col-lg-12">
                        <form id="general-settings" method="POST" action="{{ route('admin.customer.update', $customer) }}">
                            @csrf
                            @method('PUT')
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="name"
                                    ...
                                    placeholder="Tên" value="{{ old('name') ?? $customer->name }}" spellcheck="false">
                                @error('name')
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="phone_number"
                                    ...
                                    value="{{ old('phone_number') ?? $customer->phone_number }}" spellcheck="false"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <input type="text" name="email"
                                    ...
                                    placeholder="Email" value="{{ old('email') ?? $customer->email }}" spellcheck="false"
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" id="address"
                                    rows="3" placeholder="Địa chỉ" spellcheck="false" @error('address') is-invalid @enderror>{{ old('address') ?? $customer->address }}</textarea>
                                @error('address')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>

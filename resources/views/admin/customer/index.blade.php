        ...
        <div id="users-box" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    @can(Acl::PERMISSION_CUSTOMER_ADD_BUSINESS)
        ...
        const c1 = $('#datatable').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "class": "text-center",
                    "render": function(data, type, full) {
                        let urlEdit = `{{ route('admin.customer.edit', ':id') }}`.replace(':id', data);
                        let urlDestroy = `{{ route('admin.customer.destroy', ':id') }}`.replace(':id',
                            data);

                        return `
                            <div class="action-btns">
                                <x-table.actions.edit-action
                                    :permission="Acl::PERMISSION_CUSTOMER_EDIT_BUSINESS"
                                    :url="'${urlEdit}'"
                                />
                                <x-table.actions.delete-action
                                    :permission="Acl::PERMISSION_CUSTOMER_DELETE_BUSINESS"
                                    :url="'${urlDestroy}'"
                                />
                            </div>
                        `;

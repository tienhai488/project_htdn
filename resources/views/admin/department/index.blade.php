        ...
        <div id="users-box" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    @can(Acl::PERMISSION_DEPARTMENT_ADD_HR)
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full) {
                        let urlEdit = `{{ route('admin.department.edit', ':id') }}`.replace(':id',
                            data);
                        let urlDestroy = `{{ route('admin.department.destroy', ':id') }}`.replace(
                            ':id',
                            data);
                        ...
                        return `
                            <div class="action-btns">
                                <x-table.actions.edit-action
                                    :permission="Acl::PERMISSION_DEPARTMENT_EDIT_HR"
                                    :url="'${urlEdit}'"
                                />
                                <x-table.actions.delete-action
                                    :permission="Acl::PERMISSION_DEPARTMENT_DELETE_HR"
                                    :url="'${urlDestroy}'"
                                />
                            </div>
                        `;
